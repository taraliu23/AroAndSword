			...
			<div className="content-section reverse-layout">
				<div className="text-container">
					...
					<ol role="list" className="list with-rainbows">
						<li><a href="https://www.soundsfakepod.com/resource"
							target="_blank" rel="noopener noreferrer">Sounds Fake But Okay Podcast</a></li>
						<li><a href="https://taaap.org/"
							target="_blank" rel="noopener noreferrer">The Ace and Aro Advocacy Project (TAAAP)</a></li>
						<li><a href="https://www.arocalypse.com/forums/"
							target="_blank" rel="noopener noreferrer">Arocalypse</a></li>
						<li><a href="https://www.aromanticism.org/"
							target="_blank" rel="noopener noreferrer"> Aromantic-spectrum Union for Recognition, Education, and Advocacy (AUREA)</a></li>
						<li><a href="https://www.goodreads.com/book/show/128076214-hopeless-aromantic"
							target="_blank" rel="noopener noreferrer"> Hopeless Aromantic: An Affirmative Guide to Aromanticism</a></li>
						<li><a href="https://www.goodreads.com/book/show/121245340-amazing-ace-awesome-aro"
							target="_blank" rel="noopener noreferrer"> Hopeless Aromantic: An Affirmative Guide to Aromanticism</a></li>
						<li><a href="https://www.goodreads.com/book/show/128076214-hopeless-aromantic"
							target="_blank" rel="noopener noreferrer"> Amazing Ace, Awesome Aro: An Illustrated Exploration</a></li>
